...
class TestRunConversationCodexPath:
    def test_rich_message_forwarded_to_codex_session(self, monkeypatch):
        received = []
        def run_turn(self, user_input, **kwargs):
            received.append(user_input)
            return TurnResult(final_text="screen received", projected_messages=[])
        ...
        with patch.object(agent, "_spawn_background_review", return_value=None):
            agent.run_conversation(content)
