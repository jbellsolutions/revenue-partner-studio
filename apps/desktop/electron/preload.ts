...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  getBootProgress: () => ipcRenderer.invoke('hermes:boot-progress:get'),
      orgoDesktop: {
        previewHistory: payload => ipcRenderer.invoke('hermes:orgo-desktop:history:preview', payload),
        historyTargets: computerId => ipcRenderer.invoke('hermes:orgo-desktop:history:targets', computerId),
        shareHistory: payload => ipcRenderer.invoke('hermes:orgo-desktop:history:share', payload),
        listInstances: refresh => ipcRenderer.invoke('hermes:orgo-desktop:instances', refresh),
        openComputer: payload => ipcRenderer.invoke('hermes:orgo-desktop:computer:open', payload),
        setDefaultInstance: name => ipcRenderer.invoke('hermes:orgo-desktop:instance:default', name),
        fitWindow: () => ipcRenderer.invoke('hermes:orgo-desktop:window:fit'),
        openInstance: name => ipcRenderer.invoke('hermes:orgo-desktop:instance:open', name),
        ...
        setScreenPaused: (profile, paused) => ipcRenderer.invoke('hermes:orgo-desktop:control', profile, paused),
        saveKey: key => ipcRenderer.invoke('hermes:orgo-desktop:key:save', key),
        status: () => ipcRenderer.invoke('hermes:orgo-desktop:status'),
        getComputer: () => ipcRenderer.invoke('hermes:orgo-desktop:computer:get'),
        ...
        syncSkills: (sourcePath?: string) =>
          ipcRenderer.invoke('hermes:orgo-desktop:skills:sync', sourcePath)
      },
  connectors: {
