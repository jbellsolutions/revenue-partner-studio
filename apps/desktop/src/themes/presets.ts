...
const ORGO_SANS =
  'Inter, -apple-system, BlinkMacSystemFont, "SF Pro Text", "Segoe UI", system-ui, sans-serif, ' + EMOJI_FALLBACK
...
/**
 * Orgo Black — the product shell shared with Orgo Bot. The near-black canvas,
 * quiet charcoal hierarchy, and restrained hairlines deliberately keep chrome
 * out of the way of agents, messages, and computer content.
 */
export const orgoTheme: DesktopTheme = {
  name: 'orgo',
  label: 'Orgo Black',
  description: 'Near-black canvas with quiet charcoal surfaces',
  colors: {
    background: '#F7F7F7',
    foreground: '#171717',
    card: '#FFFFFF',
...
/**
 * Legacy Nous palette, retained for import compatibility while persisted Nous
 * selections migrate to the canonical Orgo Black product shell.
 */
...
export const DEFAULT_SKIN_NAME = 'orgo'
