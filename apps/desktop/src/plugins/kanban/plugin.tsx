 ...
 *
 * Enabled by default in the Bot product so delegated tasks are discoverable;
 * opt-in in generic Hermes. A saved user preference still takes precedence.
 */
