...
// v2 intentionally does not inherit the legacy preference. Earlier builds
// described the normal product transcript as "technical" often enough that
// users could end up permanently opted into a wall of thoughts/tool rows. The
// final-answer-first redesign makes detailed traces an explicit fresh choice.
const TOOL_VIEW_TECHNICAL_STORAGE_KEY = 'hermes.desktop.toolView.technical.v2'
