import { StudioConversationMount } from '@/app/bot-product/studio-collaboration'
import { StudioConnectionEmpty } from '@/app/bot-product/studio-identity'
...
export const ChatView = memo(function ChatView({
  ...
  return (
    ...
    >
      {isPrimary && <StudioConversationMount />}
      {isPrimary && isBotProduct() && !gatewayOpen && !activeSessionId && <StudioConnectionEmpty />}
