...
interface GatewaySettingsState {
  ...
  // Whether protected desktop secret storage is available.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // and this machine has no protected secret store. In that case
  ...
  const performSave = async (apply: boolean, allowPlainTextToken: boolean) => {
    ...
    try {
      ...
      const errors = {
        ...
        'reauth-required': g.sshErrTailscaleCheck,
