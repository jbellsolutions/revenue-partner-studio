...
const BOT_RELEASE_NOTES_URL = 'https://github.com/jbellsolutions/orgo-ai-guy-bot/releases'
...
export function AboutSettings() {
  ...
  if (!genericUpdates) {
    statusLine = 'Updates are checked daily and installed by verified Revenue Partner Studio maintenance.'
  } else if (!supported) {
