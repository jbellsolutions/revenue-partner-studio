...
export const zh: Translations = {
  botWorkspace: {
    refreshComputers: '刷新计算机',
    checkedAt: '上次检查',
    computerMissing: '未找到或无访问权限',
    computerUnknown: '状态不可用',
    computerSetupDescription: '此应用实例连接一台 Orgo 电脑，由其代理共享。如需使用其他电脑，请打开另一个电脑窗口。Orgo API 密钥按此实例加密并保存在本地。',
    openWorkerThread: '打开执行智能体会话',
    taskUpdate: '团队任务更新',
    taskWorker: '执行智能体',
    taskAssignee: '分配给',
    teamTasks: '团队任务',
    tasksUnavailable: '任务看板不可用。请在设置中检查桌面插件，然后重试。',
    shareHistory: "分享历史",
    sharePreview: "审核分享的摘录",
    shareNotice: "仅将审核后的文本复制给所选智能体。不共享源数据库、文件、凭据或持续访问权限，也不会运行模型或工具。",
    targetComputer: "接收计算机",
    targetAgent: "接收智能体",
    partialHistory: "仅显示最近50条消息，最多20,000字符。不包含工具、系统及隐藏消息。",
    shared: "历史已复制到所选智能体的会话。",
    shareNow: "分享此摘录",
    openShared: "打开接收方",
    deliveryPending: "发送尚未确认。请勿重新发送，请检查接收方的历史。",
    "computers": "计算机窗口",
    "primary": "主窗口 · Orgo AI Guy Bot",
    "newComputer": "添加计算机窗口",
    "instanceName": "窗口名称",
    "isolation": "每个窗口保留独立的计算机连接。同一计算机上的智能体拥有独立的配置历史，但共享主机文件系统。",
    "threads": "智能体会话",
    "newThread": "新建会话",
    "empty": "暂无已保存的会话。发送消息后即可保存新会话。",
    "untitled": "未命名会话",
    "more": "显示更多",
    "newAgent": "创建智能体",
    "unconfigured": "需要设置",
  ...
  boot: {
    ...
    failure: {
      ...
      authorizeTailscaleAndReconnect: '授权 Tailscale 并重新连接',
      tailscaleCheckHint: '请在浏览器中完成快速身份验证。返回后应用会自动重新连接。',
      tailscaleCheckFailed: '无法打开 Tailscale 身份验证'
    }
  },
  ...
  connectors: {
    ...
    keyHelp: '从 Composio → Install 复制 Connect 密钥（以 ck_ 开头）。会通过受保护的桌面存储加密，永远不会进入对话。',
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrTailscaleCheck: '此 Mac 重新连接前，Tailscale 需要进行一次快速身份验证。',
