...
export interface Translations {
  botWorkspace: {
    refreshComputers: string
    checkedAt: string
    computerMissing: string
    computerUnknown: string
    computerSetupDescription: string
    taskUpdate: string
    taskWorker: string
    openWorkerThread: string
    taskAssignee: string
    teamTasks: string
  ...
  boot: {
    ...
    failure: {
      ...
      authorizeTailscaleAndReconnect: string
      tailscaleCheckHint: string
      tailscaleCheckFailed: string
    }
  }
