...
export const zhHant = defineLocale({
  botWorkspace: {
    refreshComputers: '重新整理電腦',
    checkedAt: '上次檢查',
    computerMissing: '找不到或無存取權限',
    computerUnknown: '狀態無法取得',
    computerSetupDescription: '此應用程式實例連接一台 Orgo 電腦，由其代理共用。如需使用其他電腦，請開啟另一個電腦視窗。Orgo API 金鑰會依此實例加密並儲存在本機。',
    openWorkerThread: '開啟執行代理的對話串',
    taskUpdate: '團隊任務更新',
    taskWorker: '執行代理',
    taskAssignee: '指派給',
    teamTasks: '團隊任務',
    tasksUnavailable: '任務看板無法使用。請在設定中檢查桌面外掛，然後重試。',
    shareHistory: "分享歷史",
    sharePreview: "檢閱分享的摘錄",
    shareNotice: "僅將檢閱後的文字複製給所選代理。不分享來源資料庫、檔案、憑證或持續存取權限，也不會執行模型或工具。",
    targetComputer: "接收電腦",
    targetAgent: "接收代理",
    partialHistory: "僅顯示最新50則訊息，最多20,000字元。不包含工具、系統及隱藏訊息。",
    shared: "歷史已複製到所選代理的對話串。",
    shareNow: "分享此摘錄",
    openShared: "開啟接收端",
    deliveryPending: "傳送尚未確認。請勿重新傳送，請檢查接收端的歷史。",
    "computers": "電腦視窗",
    "primary": "主視窗 · Orgo AI Guy Bot",
    "newComputer": "新增電腦視窗",
    "instanceName": "視窗名稱",
    "isolation": "每個視窗保留獨立的電腦連線。同一電腦上的代理有獨立的設定歷史，但共用主機檔案系統。",
    "threads": "代理對話串",
    "newThread": "新增對話串",
    "empty": "尚無已儲存的對話串。傳送訊息即可儲存新對話串。",
    "untitled": "未命名對話串",
    "more": "顯示更多",
    "newAgent": "建立代理",
    "unconfigured": "需要設定",
  ...
  boot: {
    ...
    failure: {
      ...
      authorizeTailscaleAndReconnect: '授權 Tailscale 並重新連線',
      tailscaleCheckHint: '請在瀏覽器中完成快速身分驗證。返回後應用程式會自動重新連線。',
      tailscaleCheckFailed: '無法開啟 Tailscale 身分驗證'
    }
  },
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrTailscaleCheck: '此 Mac 重新連線前，Tailscale 需要進行一次快速身分驗證。',
  ...
  rightSidebar: {
    desktop: { takeControl: '接管控制', resumeAgent: '恢復代理' },
    aria: '右側邊欄',
    panelsAria: '右側邊欄面板',
    files: '檔案系統',
    terminal: '終端機',
