...
export const ar = defineLocale({
  botWorkspace: {
    refreshComputers: 'تحديث أجهزة الكمبيوتر',
    checkedAt: 'آخر تحقق',
    computerMissing: 'غير موجود أو لا يوجد إذن وصول',
    computerUnknown: 'الحالة غير متاحة',
    computerSetupDescription: 'يتصل مثيل التطبيق هذا بحاسوب Orgo واحد يشترك فيه وكلاؤه. افتح نافذة حاسوب أخرى لاستخدام حاسوب مختلف. يُحفظ مفتاح Orgo API محليًا ومشفّرًا لهذا المثيل.',
    openWorkerThread: 'فتح محادثة الوكيل المنفذ',
    taskUpdate: 'تحديث مهمة الفريق',
    taskWorker: 'الوكيل المنفذ',
    taskAssignee: 'مسندة إلى',
    teamTasks: 'مهام الفريق',
    tasksUnavailable: 'لوحة المهام غير متاحة. تحقّق من إضافات سطح المكتب في الإعدادات وحاول مرة أخرى.',
    shareHistory: "مشاركة السجل",
    sharePreview: "مراجعة المقتطف",
    shareNotice: "يُنسخ النص الذي راجعته فقط إلى الوكيل المحدد، دون قاعدة البيانات أو الملفات أو بيانات الاعتماد أو وصول مستمر. لا تُشغّل المشاركة نموذجًا أو أدوات.",
    targetComputer: "الحاسوب المستلم",
    targetAgent: "الوكيل المستلم",
    partialHistory: "تقتصر المعاينة على أحدث 50 رسالة و20,000 حرف، دون رسائل الأدوات والنظام والرسائل المخفية.",
    shared: "نُسخ السجل إلى محادثة الوكيل المحدد.",
    shareNow: "مشاركة هذا المقتطف",
    openShared: "فتح الوجهة",
    deliveryPending: "لم يتأكد التسليم. لا تبدأ إرسالًا آخر؛ تحقق من سجل الوكيل المستلم.",
    "computers": "نوافذ الحواسيب",
    "primary": "الرئيسي · Revenue Partner Studio",
    "newComputer": "إضافة نافذة حاسوب",
    "instanceName": "اسم النافذة",
    "isolation": "تحتفظ كل نافذة باتصالها الخاص. للوكلاء على الحاسوب نفسه سجلات منفصلة، لكنهم يشتركون في نظام ملفات المضيف.",
    "threads": "محادثات الوكيل",
    "newThread": "محادثة جديدة",
    "empty": "لا توجد محادثات محفوظة. أرسل رسالة لحفظ محادثة جديدة.",
    "untitled": "محادثة بلا عنوان",
    "more": "عرض المزيد",
    "newAgent": "إنشاء وكيل",
    "unconfigured": "يلزم الإعداد",
    "unreadable": "تعذرت قراءة الاتصال"
  },
  common: {
    apply: 'تطبيق',
    back: 'رجوع',
  ...
  rightSidebar: {
    desktop: { takeControl: 'تولّي التحكم', resumeAgent: 'استئناف الوكيل' },
