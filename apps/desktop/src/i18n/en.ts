...
export const en: Translations = {
  botWorkspace: {
    ...
    computerMissing: 'Not found or no access',
    computerUnknown: 'Status unavailable',
    computerSetupDescription: 'This window stays connected to its own computer. Use Open another computer for a separate workspace. Your Orgo API key is stored locally, encrypted for this app.',
    taskUpdate: 'Team task update',
    taskWorker: 'Worker',
    openWorkerThread: 'Open worker thread',
    taskAssignee: 'Assigned to',
    teamTasks: 'Team tasks',
    tasksUnavailable: 'The task board is unavailable. Check desktop plugins in Settings and try again.',
    shareHistory: "Share history",
    sharePreview: "Review shared excerpt",
    shareNotice: "Only this reviewed text is copied to the selected agent. No source database, files, credentials, or ongoing access are shared. Sharing does not run a model or tools.",
    targetComputer: "Receiving computer",
    targetAgent: "Receiving agent",
    partialHistory: "Preview limited to the latest 50 messages and 20,000 characters. Tool, system, and hidden messages are excluded.",
    shared: "History copied to the selected agent’s thread.",
    shareNow: "Share this excerpt",
    openShared: "Open destination",
    deliveryPending: "Delivery is not confirmed. Do not start another handoff; check the receiving agent’s history.",
    "computers": "Computer windows",
    "primary": "Primary · Studio",
    "newComputer": "Add computer window",
    "instanceName": "Window name",
    "isolation": "Each window keeps its own computer connection. Agents on the same computer have separate profile histories, but share the host filesystem.",
    "threads": "Agent threads",
    "newThread": "New thread",
    "empty": "No saved threads yet. Send a message to save a new thread.",
    "untitled": "Untitled thread",
    "more": "Show more",
    "newAgent": "Create agent",
    "unconfigured": "Setup required",
    "unreadable": "Unable to read binding"
  },
  common: {
    apply: 'Apply',
    back: 'Back',
  ...
  boot: {
    ...
    failure: {
      ...
      authorizeTailscaleAndReconnect: 'Authorize Tailscale & reconnect',
      tailscaleCheckHint:
        'Complete the quick identity check in your browser. Revenue Partner Studio reconnects when you return.',
      tailscaleCheckFailed: 'Could not open the Tailscale identity check'
    }
  },
  ...
  connectors: {
    ...
    keyHelp: 'Paste the Connect key from Composio → Install (starts with ck_). It is encrypted in protected desktop storage and never sent to chat.',
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrTailscaleCheck: 'Tailscale needs a quick identity check before this Mac can reconnect.',
