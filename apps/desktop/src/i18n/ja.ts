...
export const ja = defineLocale({
  botWorkspace: {
    refreshComputers: 'コンピューターを更新',
    checkedAt: '最終確認',
    computerMissing: '見つからないかアクセス不可',
    computerUnknown: '状態を取得できません',
    computerSetupDescription: 'このアプリのインスタンスは、エージェント間で共有する1台のOrgoコンピューターに接続します。別のコンピューターには、別のコンピューターウィンドウを開いてください。Orgo APIキーは、このインスタンス用に暗号化され、ローカルに保存されます。',
    openWorkerThread: '作業エージェントのスレッドを開く',
    taskUpdate: 'チームタスクの更新',
    taskWorker: '実行エージェント',
    taskAssignee: '担当',
    teamTasks: 'チームのタスク',
    tasksUnavailable: 'タスクボードを利用できません。設定でデスクトッププラグインを確認し、もう一度お試しください。',
    shareHistory: "履歴を共有",
    sharePreview: "共有する抜粋を確認",
    shareNotice: "確認したテキストだけを選択したエージェントにコピーします。元のデータベース、ファイル、認証情報、継続的なアクセス権は共有しません。モデルやツールは実行しません。",
    targetComputer: "受信先コンピューター",
    targetAgent: "受信先エージェント",
    partialHistory: "最新50件、20,000文字まで表示します。ツール、システム、非表示メッセージは除外します。",
    shared: "選択したエージェントのスレッドに履歴をコピーしました。",
    shareNow: "この抜粋を共有",
    openShared: "共有先を開く",
    deliveryPending: "配信は未確認です。再送せず、受信先の履歴を確認してください。",
    "computers": "コンピューターのウィンドウ",
    "primary": "メイン · Revenue Partner Studio",
    "newComputer": "コンピューターのウィンドウを追加",
    "instanceName": "ウィンドウ名",
    "isolation": "各ウィンドウは独自の接続を保持します。同じコンピューターのエージェントは履歴が別々ですが、ホストのファイルシステムを共有します。",
    "threads": "エージェントのスレッド",
    "newThread": "新しいスレッド",
    "empty": "保存済みスレッドはありません。メッセージを送信すると保存されます。",
    "untitled": "無題のスレッド",
    "more": "さらに表示",
    "newAgent": "エージェントを作成",
    "unconfigured": "設定が必要",
    "unreadable": "接続設定を読み取れません"
  },
  common: {
    apply: '適用',
    back: '戻る',
  ...
  boot: {
    ...
    failure: {
      ...
      authorizeTailscaleAndReconnect: 'Tailscale を承認して再接続',
      tailscaleCheckHint: 'ブラウザーで簡単な本人確認を完了してください。戻ると自動的に再接続します。',
      tailscaleCheckFailed: 'Tailscale の本人確認を開けませんでした'
    }
  },
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrTailscaleCheck: 'この Mac を再接続する前に、Tailscale の簡単な本人確認が必要です。',
  ...
  rightSidebar: {
    desktop: { takeControl: '操作を引き継ぐ', resumeAgent: 'エージェントを再開' },
    aria: '右サイドバー',
