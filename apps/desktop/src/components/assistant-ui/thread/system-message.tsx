...
export const SystemMessage: FC = () => {
  ...
  const taskUpdates = useAuiState(s => s.message.metadata.custom.taskUpdates as TaskUpdate[] | undefined)
  ...
  if (taskUpdates) {
    return (
      <MessagePrimitive.Root
        className="w-full min-w-0 self-start py-2"
        data-role="system"
        data-slot="aui_system-message-root"
      >
        <TaskDeliveryNote text={text} updates={taskUpdates} />
      </MessagePrimitive.Root>
    )
  }
