...
export const APPROVAL_TOOLS = new Set(['terminal', 'execute_code', 'studio_team'])
  ...
  const respond = useCallback(
    async (choice: ApprovalChoice) => {
      ...
      try {
        ...
        if (!result.resolved) throw new Error('This approval is no longer pending. Refresh the conversation before approving another action.')
    ...
    [busy, copy.gatewayDisconnected, copy.sendFailed, gateway, request.sessionId, request.requestId]
  )
