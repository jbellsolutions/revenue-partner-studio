  ...
  return (
    ...
    >
      {/* Persistent hairline: same token as PaneShell's divider sash
          ...
          reads identically. It stays fully visible because this sash owns the
          whole pane boundary, including tab/header bands that pane-content
          borders cannot reach. Hover still adds the thicker grab band. */}
      <span
        className={cn(
