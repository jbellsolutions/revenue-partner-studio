...
export { registerAgentThreadOpener } from '@/app/bot-product/agent-thread-navigation'
export { TeamTasksButton } from '@/app/bot-product/team-tasks-button'
export { WorkerThreadLink } from '@/app/bot-product/worker-thread-link'
export { AgentThreads, ComputerWindows } from '@/app/bot-product/workspace-controls'
...
export { BOT_APP_NAME, isBotProduct } from '@/lib/product'
