...
> This file documents the generic upstream Hermes Desktop SKU. For the Revenue Partner Studio product, start with the repository [`README.md`](../../README.md) and [`INSTALL.md`](../../INSTALL.md).
